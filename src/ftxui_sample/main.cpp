...
// configuration step. It creates a namespace called `factrory_craft`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", factrory_craft::cmake::project_name, factrory_craft::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", factrory_craft::cmake::project_version);
      return EXIT_SUCCESS;
    }
